...
\bibitem[\protect\citename{{Karen Spärck Jones}}2007]{IPM:2007}
{Karen Spärck Jones}
\newblock 2007.
\newblock {Information Processing & Management.}
\newblock {\em Automatic summarising: The state of the art}
\newblock Elsevier

\bibitem[\protect\citename{{Nenkova, A., Passonneau, R., and McKeown, K.}}2007]{ACM:2007}
{Nenkova, A., Passonneau, R., and McKeown, K.}
\newblock 2007.
\newblock { The pyramid method: Incorporating human
content selection variation in summarization evaluation.}
\newblock {\em ACM Trans. Speech Lang. Process. 4,
1, Article 4 (May 2007), 23 pages. DOI = 10.1145/1233912.1233913 http://doi.acm.org/10.1145/
1233912.1233913}

\bibitem[\protect\citename{{Radev, D., Blair-Goldensohn, S., Zhang, Zhu.}}2001]{UM:2001}
{Radev, D., Blair-Goldensohn, S., Zhang, Zhu.}
\newblock 2001.
\newblock { Experiments in Single and Multi-Document Summarization
Using MEAD.}
\newblock {\em School of Information, University of Michigan, Ann Arbor, MI}
